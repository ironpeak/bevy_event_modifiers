...
use syn::{
    ...
    AngleBracketedGenericArguments, Data, DeriveInput, Field, GenericArgument, Ident,
    PathArguments, Type,
};
...
pub fn derive_event_modifier_context(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let output = quote! {
        ...
        pub struct #modifier_ty {
            ...
            pub modify: fn(&mut #struct_name, &mut #output_ty),
        }
